    ...
    <div class="container nav-admin">
        ...
        <div class="d-flex">
            ...
            <div class="all-manage-page">
                <h2 class="my-3">ออเดอร์ทั้งหมด</h2>
                <table>
                    <tr>
                        <td>Oder Id</td>
                        <td>Oder Date</td>
...
while ($rows = mysqli_fetch_assoc($result)) {?>
                    <tr>
                        ...
                        <td><a
                                href="more-order-detail.php?more-detail=<?php echo $rows['order_id']; ?>">ดูรายละเอียดเพิ่มเติม</a>
                        </td>
                        <td><a href="delete_process.php?delete-order=<?php echo $rows['order_id']; ?>">ลบ</a></td>
                    </tr>
                    <?php }?>
                </table>
            </div>
